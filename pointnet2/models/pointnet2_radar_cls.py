...
from pointnet2.utils.pointnet2_modules import PointnetSAModuleMSG2D, PointnetSAModule2D, PointnetFPModule2D
...
class Pointnet2Radar(nn.Module):
    r"""
    ...
    def _break_up_pc(self, pc):
        xyz = pc[..., 0:2].contiguous()
        features = pc[..., 2:].transpose(1, 2).contiguous() if pc.size(-1) > 3 else None
