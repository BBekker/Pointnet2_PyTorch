...
class _PointnetSAModuleBase2D(nn.Module):
    def __init__(self):
        super(_PointnetSAModuleBase, self).__init__()
        self.npoint = None
        self.groupers = None
...
class PointnetSAModuleMSG2D(_PointnetSAModuleBase2D):
    r"""Pointnet set abstrction layer with multiscale grouping
...
class PointnetSAModule2D(PointnetSAModuleMSG2D):
    r"""Pointnet set abstrction layer
...
class PointnetFPModule2D(nn.Module):
    r"""Propigates the features of one set to another
    ...
    def forward(self, unknown, known, unknow_feats, known_feats):
        ...
        ----------
        unknown : torch.Tensor
            (B, n, 2) tensor of the Azimuth distance positions of the unknown features
        known : torch.Tensor
            (B, m, 2) tensor of the Azimuth distance positions of the known features
        unknow_feats : torch.Tensor
            (B, C1, n) tensor of the features to be propigated to
        known_feats : torch.Tensor
            (B, C2, m) tensor of features to be propigated
